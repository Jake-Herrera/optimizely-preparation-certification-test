...
export default function PreparationPage() {
    ...
    const questions = developerQuestions.questions
                                            ...
                                            {getAvailableOptions().map((option) => (
                                                <div key={option.key} className="flex items-center space-x-2">
                                                    <RadioGroupItem
                                                        value={option.key}
                                                        id={option.key}
                                                        className={`${option.key === currentQuestion.answer
                                                    ...
                                                    <Label htmlFor={option.key} className="flex-1">
                                                        <span
                                                            className={`font-medium ${option.key === currentQuestion.answer
                                                                    ? "text-green-700"
                                                                    : option.key === selectedAnswer && !isCorrect
                                                                        ? "text-red-700"
                                                                        : ""
